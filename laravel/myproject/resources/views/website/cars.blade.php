						 ...
						 <div class="modal-body about">
								<div class="login-top cars sign-top one">
								   ...
								   <h5>$36000</h5>
			                        ...
			                        <img src="{{url('Frontend/images/4.jpg')}}" alt="Catchy Carz">
						...
						<div class="col-md-9 search-car-right-text w3">
							...
							<div id="products" class="row list-group">
								<div class="item  col-xs-4 col-lg-4">
									<div class="thumbnail">
										 <a href="#" data-toggle="modal" data-target="#myModal6"><img class="group list-group-image" src="{{url('Frontend/images/f2.jpg')}}" alt="Catchy Carz"></a>
								...
								<div class="item  col-xs-4 col-lg-4">
									<div class="thumbnail">
										 <a href="#" data-toggle="modal" data-target="#myModal6"><img class="group list-group-image" src="{{url('Frontend/images/f3.jpg')}}" alt="Catchy Carz"></a>
		                                       <div class="table-text">
								...
								<div class="item  col-xs-4 col-lg-4">
									<div class="thumbnail">
										 <a href="#" data-toggle="modal" data-target="#myModal6"><img class="group list-group-image" src="{{url('Frontend/images/f1.jpg')}}" alt="Catchy Carz"></a>
		                                       <div class="table-text">
								...
								<div class="item  col-xs-4 col-lg-4">
									<div class="thumbnail">
										 <a href="#" data-toggle="modal" data-target="#myModal6"><img class="group list-group-image" src="{{url('Frontend/images/f4.jpg')}}" alt="Catchy Carz"></a>
		                                       <div class="table-text">
								...
								<div class="item  col-xs-4 col-lg-4">
									<div class="thumbnail">
										 <a href="#" data-toggle="modal" data-target="#myModal6"><img class="group list-group-image" src="{{url('Frontend/images/f5.jpeg')}}"" alt="Catchy Carz"></a>
		                                       <div class="table-text">
								...
								<div class="item  col-xs-4 col-lg-4">
									<div class="thumbnail">
										 <a href="#" data-toggle="modal" data-target="#myModal6"><img class="group list-group-image" src="{{url('Frontend/images/f8.jpg')}}" alt="Catchy Carz"></a>
		                                       <div class="table-text">
...
@endsection
<!---->
		<script type="text/javascript" src="{{url('Frontend/js/jquery-ui.js')}}"></script>
