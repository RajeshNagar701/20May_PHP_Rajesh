			...
			<div class="banner-info">
			  <h1><a href="index.html">Catchy <span class="logo-sub">Carz</span> </a></h1>
				...
				<p>Eye it – try it – buy it!</p>
			       <form action="#" method="post">
					...
					<select id="country" onchange="change_country(this.value)" class="frm-field required">
						<option value="null"><img src="{{url('Frontend/images/rupee.png')}}" alt=" " class="img-responsive" />Brands</option>
				...
				<div class="section_room">
					<select id="country" onchange="change_country(this.value)" class="frm-field required">
						<option value="null"><img src="{{url('Frontend/images/rupee.png')}}" alt=" " class="img-responsive" /> Budget</option>
...
<!--//banner-section-->
							   ...
							   <!-- /card1 -->
								  <div class="card effect__hover">
									<div class="card__front">
									  <span class="card__text">
									       <div class="img-grid">
													<img src="{{url('Frontend/images/f1.jpg')}}" alt="Catchy Carz">
								  ...
								  <div class="card effect__hover">
									<div class="card__front">
									  <span class="card__text">
									       <div class="img-grid">
													<img src="{{url('Frontend/images/f2.jpg')}}" alt="Catchy Carz">
													<div class="car_description">
								  ...
								  <div class="card effect__hover">
									<div class="card__front">
									  <span class="card__text">
									       <div class="img-grid">
													<img src="{{url('Frontend/images/f3.jpg')}}" alt="Catchy Carz">
													<div class="car_description">
							   ...
							   <!-- /card1 -->
								  <div class="card effect__hover">
									<div class="card__front">
									  <span class="card__text">
									       <div class="img-grid">
													<img src="{{url('Frontend/images/f4.jpg')}}" alt="Catchy Carz">
													<div class="car_description">
									...
									<div class="card__back">
									  <span class="card__text">
									     	 <div class="login-inner2">
												<h4><img src="{{url('Frontend/images/rupee.png')}}" alt="Catchy Carz"> Check On-Road Price</h4>
											<div class="login-top sign-top">
												 <form action="#" method="post">
													<input type="text" name="name" class="name active" placeholder="Name" required=""/>
													<input type="text" name="email" class="email" placeholder="Email" required=""/>
								  ...
								  <div class="card effect__hover">
									<div class="card__front">
									  <span class="card__text">
									       <div class="img-grid">
													<img src="{{url('Frontend/images/f5.jpeg')}}" alt="Catchy Carz">
													<div class="car_description">
								  ...
								  <div class="card effect__hover">
									<div class="card__front">
									  <span class="card__text">
									       <div class="img-grid">
													<img src="{{url('Frontend/images/f6.jpeg')}}" alt="Catchy Carz">
													<div class="car_description">
														 <h4><a href="single.html"> Mercedes-Benz C250 CDI</a></h4>
							   ...
							   <!-- /card1 -->
								  <div class="card effect__hover">
									<div class="card__front">
									  <span class="card__text">
									       <div class="img-grid">
													<img src="{{url('Frontend/images/f7.jpg')}}" alt="Catchy Carz">
													<div class="car_description">
								  ...
								  <div class="card effect__hover">
									<div class="card__front">
									  <span class="card__text">
									       <div class="img-grid">
													<img src="{{url('Frontend/images/f8.jpg')}}" alt="Catchy Carz">
													<div class="car_description">
								  ...
								  <div class="card effect__hover">
									<div class="card__front">
									  <span class="card__text">
									       <div class="img-grid">
													<img src="{{url('Frontend/images/f9.jpg')}}" alt="Catchy Carz">
													<div class="car_description">
			  ...
			  <div class="col-md-7 slide-show-w3l">
				 ...
				 <h6 class="sub">Great Prices. Great Vehicles. Great Service.</h6>
							<div class="car-view-slider">
					          <ul id="flexiselDemo">
							 <li>
								 <a href="upcoming.html"><img src="{{url('Frontend/images/n2.jpg')}}" alt=""/>
								  <div class="caption">
							 ...
							 <li>
								 <a href="upcoming.html"><img src="{{url('Frontend/images/n1.jpeg')}}" alt=""/>
								 <div class="caption">
							 ...
							 <li>
								 <a href="upcoming.html"><img src="{{url('Frontend/images/n3.jpg')}}" alt=""/>
								  <div class="caption">
							 ...
							 <li>
								 <a href="upcoming.html"><img src="{{url('Frontend/images/n4.jpg')}}" alt=""/>
									<div class="caption">
					...
					<div class="col-md-5 new-car-used">
					  ...
					  <div class="used-one">
					     <figure class="effect-zoe">
							 <a href="used.html"><img src="{{url('Frontend/images/used_car.jpg')}}" alt="Used Car"></a>
							<figcaption>
					  ...
					  <div class="clearfix"> </div>
					   <div class="used-one second">
					     <figure class="effect-zoe">
							<a href="used.html"><img src="{{url('Frontend/images/used_car1.jpg')}}" alt="Used Car"></a>
							<figcaption>
								<h4>CATCHY <span>CARZ</span></h4>
								<p class="icon-links">
									<a href="#"><i class="glyphicon glyphicon-heart-empty"></i></a>
	...
	<!-- /slider1 -->
		...
		<div class="arrival-grids">			 
			 <ul id="flexiselDemo1">
				 <li>
					 <a href="single.html"><img src="{{url('Frontend/images/f1.jpg')}}" alt=""/>
					  <div class="caption">
				 ...
				 <li>
					 <a href="single.html"><img src="{{url('Frontend/images/f2.jpg')}}" alt=""/>
					 <div class="caption">
				 ...
				 <li>
					 <a href="single.html"><img src="{{url('Frontend/images/f3.jpg')}}" alt=""/>
					  <div class="caption">
				 ...
				 <li>
					 <a href="single.html"><img src="{{url('Frontend/images/f4.jpg')}}" alt=""/>
					    <div class="caption">
				 ...
				 <li>
					 <a href="single.html"><img src="{{url('Frontend/images/f7.jpg')}}" alt=""/>
					    <div class="caption">
				 ...
				 <li>
					 <a href="single.html"><img src="{{url('Frontend/images/f5.jpeg')}}" alt=""/>
					 <div class="caption">
				  ...
				  <li>
					 <a href="single.html"><img src="{{url('Frontend/images/f8.jpg')}}" alt=""/>
					    <div class="caption">
							 ...
							 <div class="news-updates">
										...
										<div class="col-md-5 tab-image">
											<div class="view second-effect">
												<a href="single.html" title="Catchy Carz">
													<img src="{{url('Frontend/images/u1.jpeg')}}" alt="" class="img-responsive">
													<div class="mask">
									...
									<div class="update-info-w3l two">
										...
										<div class="col-md-5 tab-image">
											<div class="view second-effect">
												<a href="single.html" title="Catchy Carz">
													<img src="{{url('Frontend/images/u2.jpg')}}" alt="" class="img-responsive">
													<div class="mask">
														<p>Catchy <span>Carz</span> </p>
													</div>
												</a>	
								...
								<div class="news-updates">
									<div class="update-info-w3l">
										<div class="col-md-5 tab-image">
											<div class="view second-effect">
												<a href="single.html" title="Catchy Carz">
													<img src="{{url('Frontend/images/u3.jpg')}}" alt="" class="img-responsive">
													<div class="mask">
														<p>Catchy <span>Carz</span> </p>
													</div>
												</a>	
									...
									<div class="update-info-w3l two">
										...
										<div class="col-md-5 tab-image">
											<div class="view second-effect">
											<a href="single.html" title="Catchy Carz">
													<img src="{{url('Frontend/images/u4.jpeg')}}" alt="" class="img-responsive">
													<div class="mask">
														<p>Catchy <span>Carz</span> </p>
													</div>
												</a>	
