 <footer class="main-footer">
    ...
    <script src="{{url('Backend/plugins/morris/morris.min.js')}}" type="text/javascript"></script>
    <!-- Sparkline -->
    ...
    <!-- jQuery Knob Chart -->
    <script src="{{url('Backend/plugins/knob/jquery.knob.js')}}" type="text/javascript"></script>
    <!-- daterangepicker -->
    ...
    <!-- Bootstrap WYSIHTML5 -->
    <script src="{{url('Backend/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js')}}" type="text/javascript"></script>
    <!-- iCheck -->
    ...
    <!-- AdminLTE App -->
    <script src="{{url('Backend/dist/js/app.min.js')}}" type="text/javascript"></script>

    <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
    <script src="{{url('Backend/dist/js/pages/dashboard.js')}}" type="text/javascript"></script>

    <!-- AdminLTE for demo purposes -->
    <script src="{{url('Backend/dist/js/demo.js')}}" type="text/javascript"></script>
  </body>
</html>