...
@section('remaining_content')
			...
			<div class="slider_wrapper ">
				<div id="camera_wrap" class="">
					<div data-src="{{url('Frontend/images/slide.jpg')}}" ></div>
					<div data-src="{{url('Frontend/images/slide1.jpg')}}" ></div>
					<div data-src="{{url('Frontend/images/slide2.jpg')}}"></div>
				</div>
			</div>
			<div class="container_12">
					...
					<div class="banner">
						<div class="maxheight">
							<div class="banner_title">
								<img src="{{url('Frontend/images/icon1.png')}}" alt="">
				...
				<div class="grid_4">
					<div class="banner">
						<div class="maxheight">
							<div class="banner_title">
								<img src="{{url('Frontend/images/icon2.png')}}" alt="">
				...
				<div class="grid_4">
					<div class="banner">
						<div class="maxheight">
							<div class="banner_title">
								<img src="{{url('Frontend/images/icon3.png')}}" alt="">
			...
			<div class="content"><div class="ic">More Website Templates @ TemplateMonster.com - April 07, 2014!</div>
				<div class="container_12">
					...
					<div class="grid_6 prefix_1">
						<a href="index2.html" class="type"><img src="{{url('Frontend/images/page1_img1.jpg')}}" alt=""><span class="type_caption">Economy</span></a>
						<a href="index2.html" class="type"><img src="{{url('Frontend/images/page1_img2.jpg')}}" alt=""><span class="type_caption">Standard</span></a>
						<a href="index2.html" class="type"><img src="{{url('Frontend/images/page1_img3.jpg')}}" alt=""><span class="type_caption">Lux</span></a>
					</div>
					<div class="clear"></div>
				</div>
			</div>
